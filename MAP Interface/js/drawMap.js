...
function InitMap() {
    var location = new google.maps.LatLng(45.070233, 7.677988)
    mapOptions = {
        zoom: 15,
        center: location,
    ...
    var getPolygonCoords = function(newShape) {
        ...
        console.log("HandShake from polygoncomplete Listener!")
        if (coordinates.length > 0) {
            download(coordinates, 'coordinates.txt', 'text/plain');
        } else {
    ...
    function download(content, fileName, contentType) {
        ...
        var file = new Blob([str], { type: contentType });
